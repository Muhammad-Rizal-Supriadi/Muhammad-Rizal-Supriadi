...
- **Web Development:** Laravel, NextJS, React, MUI, WordPress, NodeJS
- **Database & Queries:** MySQL, SQL Query
- **Debugging & Analytics:** Google Analytics, Google Workspaces
- **SEO & Digital Marketing:** Search Engine Optimization (SEO), Digital Marketing
- **Blockchain Knowledge:** Public & Private Blockchain Testing
